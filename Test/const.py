'''
@Author: Xiao Liang
@Date: 2019-07-26 10:51:40
@LastEditors: Xiao Liang
@LastEditTime: 2019-09-21 22:55:52
@Description: file content
'''
class Const:
	def __init__(self):
		self.M_e=5.965e27 #g
		self.M_p=5.5734693877551  #/M_e
		self.M_c=5      #/M_e
		...
		#calculate sigma
		self.sigma_1=9e9*906.4*(self.T_0/1004)**(5./4.)*(self.T_0/1500)**(
			-1./2.)*(self.P_0/1e6)**(-1./2.)
		self.sigma_2=25.19*1004/self.T_0
